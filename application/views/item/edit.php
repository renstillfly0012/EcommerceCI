    ...
    <div class="col-md-8 col-md-offset-2">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          ...
          <form class="form-horizontal" action="<?= base_url() ?>item/edit/<?= $item->id ?>" method="post">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-md-4 control-label" for="id">Quantity</label>
                <div class="col-md-2">
                  <input value="<?= $item->int_qty ?>" id="int_qty" name="int_qty" type="text" class="form-control input-md">
          ...
          <img src="<?= base_url() ?>/assets/images/thumb_img/<?= $item->image ?>" height="200" width="200" />
