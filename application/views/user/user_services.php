		...
		<div class="ser-main">
			...
			<div class="ser-grid">
				<div class="ser-grid-list">
					<a href="#"><img src="<?= base_url() ?>assets/new/images/icon1.png" alt=""></a>
				...
				<div class="ser-grid-list">
					<a href="#"><img src="<?= base_url() ?>assets/new/images/icon2.png" alt=""></a>
				...
				<div class="ser-grid-list">
					<a href="#"><img src="<?= base_url() ?>assets/new/images/icon3.png" alt=""></a>
			...
			<div class="ser-grid">
				<div class="ser-grid-list">
					<a href="#"><img src="<?= base_url() ?>assets/new/images/icon4.png" alt=""></a>
					<h5><a href="#">100% look book</a></h5>
					<p class="para">It is a long established fact that a reader will be distracted by the page when looking at its layout.</p>
				</div>
				<div class="ser-grid-list">
					<a href="#"><img src="<?= base_url() ?>assets/new/images/icon5.png" alt=""></a>
					<h5><a href="#">authentic products</a></h5>
					<p class="para"> The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
				</div>
				<div class="ser-grid-list">
					<a href="#"><img src="<?= base_url() ?>assets/new/images/icon6.png" alt=""></a>
