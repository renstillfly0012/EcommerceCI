...
<html lang="en">
  <head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
     <link rel="logo icon" type="image/png" href="<?=base_url()?>/assets/images/logo.png"/>
    <title>ItamShop</title>
  ...
  <body class="sidebar-open sidebar-mini hold-transition login-page skin-green" >
