...
<header class="main-header">
    ...
    <a href="<?=base_url()?>home/dashboard" class="logo">
      ...
      <span class="logo-mini"><b>I</b>TS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>iTAM</b>Shop</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?= base_url() ?>template/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>/assets/images/thumb_img/<?=$this->session->img?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=$this->session->full_name?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                <?=$this->session->full_name?> - Web Developer
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <button class="btn btn-default btn-flat confirm">Sign out</button>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" >
        ...
        <li>
          <a href="<?= base_url() ?>/Home/viewInventory">
...
<!-- 
        <li>
          <a href="<?= base_url() ?>/Home/viewGC">
            <i class="fa fa-th"></i> <span>Gift Certificates</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
